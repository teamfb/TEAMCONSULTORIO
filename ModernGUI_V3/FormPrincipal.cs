...
namespace ModernGUI_V3
{
    public partial class FormPrincipal : Form
    {
        ...
        private void CloseForms(object sender,FormClosedEventArgs e) {
            if (Application.OpenForms["ConsultaMedica"] == null)
                btnConsulta.BackColor = Color.FromArgb(4, 41, 68);
            if (Application.OpenForms["NuevaConsulta"] == null)
                btnNuevaConsulta.BackColor = Color.FromArgb(4, 41, 68);
        ...
        {
            AbrirFormulario<ConsultaMedica>();
